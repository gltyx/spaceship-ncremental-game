...
var cnItems = {
    ...
    "Build\n                    solar panels": "构建\n 太阳能电池板",
    "Build\n                a Dyson sphere": "构建\n 戴森球",
    "Build\n                a research center": "建立\n研究中心",
    "Build\n                a shipyard": "建造\n 造船厂",
    "Build\n                asteroid mining complex": "建造\n小行星采矿综合体",
    "Build\n                orbital telescope": "建造\n 轨道望远镜",
    "Build space\n                station": "构建空间\n 站",
    "for most problems just reset your data": "对于大多数问题，只需重置您的数据",
    "Industrialization": "工业化",
    "Multiplies\n                output of factory and fuel refinery by 2": "将\n工厂和燃料精炼厂的产量乘以 2",
    "Not enough money!": "没有足够的钱！",
    "Not enough refined resources!": "精炼资源不够！",
    "Not enough research!": "研究不够！",
    "Not enough resources!": "没有足够的资源！",
    "Building upgrades": "建筑升级",
    "Robot workers": "机器人工人",
    "Worder upgrades": "词人 升级",
    "Not enough space!": "没有足够的空间！",
    "(valuable feedback and bug reports, say hi to them on the discord)": "（有价值的反馈和错误报告，在 discord 上向他们打个招呼）",
    "Build asteroid\n                miner": "建造小行星\n 矿工",
    "Export data": "导出数据",
    "Import data": "导入数据",
    "Manufacturing": "制造业",
    "Other valuable help: Hunlight, myo, I need therapy": "其他有价值的帮助：Hunlight，myo，我需要治疗",
    "Produce refined resources here.": "在这里生产精炼资源。",
    "Produce rocket fuel here.": "在这里生产火箭燃料。",
    "Refinery": "炼油厂",
    "Robot\n                workers": "机器人\n 工人",
    "Ship Construction": "飞船建造",
    "Ship Upgrades": "飞船升级",
    "": "",
    "": "",
    "": "",
...
var cnRegReplace = new Map([
    ...
    [/^(.+) and it produces (.+) fuel per second.$/, '$1 并且它每秒产生 $2 燃料。'],
    [/^Next level will give (.+) resources per click.$/, '下一级将提供 $1 个资源，每次点击。'],
    [/^Next level will make factory produce (.+) refined resources per second.$/, '下一级将使工厂每秒生产 $1 的精炼资源。'],
    [/^Next level will make refinery produce (.+) rocket fuel per second.$/, '下一级别将使炼油厂每秒生产 $1 枚火箭燃料。'],
    [/^Next level will make solar panels produce (.+) energy per second.$/, '下一阶段将使太阳能电池板每秒产生 $1 能源。'],
    [/^Next level will make stelescope produce (.+) research points per second.$/, '下一级别将使望远镜每秒产生 $1 个研究点。'],
    [/^Next level will make the research center produce (.+) research points per second.$/, '下一级别将使研究中心每秒产生 $1 的研究点。'],
    [/^Next level will make worker housing house (.+) workers.$/, '下一级将使工人住房容纳 $1 工人。'],
    [/^Next level will make workers produce (.+) resources per second.$/, '下一个级别将使工人每秒生产 $1 个资源。'],
    [/^Next level will make you have (.+) solar panel space.$/, '下一级将使您拥有 $1 个太阳能电池板空间。'],
    [/^Upgrading factory cost (.+) money and (.+) resources.$/, '升级工厂会花费 $1 的金钱和 $2 的资源。'],
    [/^Upgrading refinery cost (.+) money and (.+) refined resources.$/, '升级炼油厂花费 $1 金钱和 $2 精炼资源。'],
    [/^Upgrading research center undefined money.$/, '升级研究中心需要 $1 金钱。'],
    [/^Upgrading resource click cost (.+) money.$/, '升级资源点击花费 $1 金钱。'],
    [/^Upgrading solar panels cost (.+) money and (.+) refined resources.$/, '升级太阳能电池板需要花费 $1 金钱和 $2 精炼资源。'],
    [/^Upgrading solar panels space costs (.+) resources.$/, '升级太阳能电池板空间需要 $1 资源。'],
    [/^Upgrading telescope cost (.+) money and (.+) refined resources.$/, '升级望远镜花费 $1 金钱和 $2精炼资源。'],
    [/^Upgrading worker cost (.+) money.$/, '升级工人需要 $1 金钱。'],
    [/^Upgrading worker housing cost (.+) money and (.+) resources.$/, '升级工人住房需要 $1 金钱和 $2 资源。'],
    [/^Uses (.+) resources to make (.+) refined resource.$/, '使用 $1 资源制作 $2 种精炼资源。'],
    [/^Uses (.+) resources and (.+) energy to make (.+) rocket fuel.$/, '使用 $1 资源和 $2 能源来制造 $3 火箭燃料。'],
    ...
    [/^Costs (.+) money and (.+) research$/, '成本 $1 金钱和 $2 研究'],
    [/^Cost: (.+) points$/, '成本：$1 点数'],
    [/^Req: (.+) elves$/, '要求：$1 精灵'],
    [/^Req: (.+) \/ (.+) elves$/, '要求：$1 \/ $2 精灵'],
    [/^Usages: (\d+)\/$/, '用途：$1\/'],
